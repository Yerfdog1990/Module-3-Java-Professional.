...
public class WithoutEqualBuilder {
    ...
    public static void main(String[] args){
        ...
        System.out.println("a.name.hashCode() == b.name.hashCode(): " + (a.name.hashCode() == b.name.hashCode()));
        System.out.println("a.name.toString() == b.name.toString(): " + (a.name.toString().equals(b.name.toString())));
    }
}