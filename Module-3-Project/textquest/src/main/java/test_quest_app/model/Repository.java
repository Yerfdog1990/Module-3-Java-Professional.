...
public class Repository {
  ...
  public Repository() {
    Question q1 =
        new Question(1, "You lost your memory. Accept UFO challenge?", Question.Type.USUAL);
    Question q2 =
        new Question(
            2,
            "You accepted the challenge. Are you going up to the captain's bridge?",
            Question.Type.USUAL);
    Question q3 = new Question(3, "You rejected the challenge. Defeat!", Question.Type.LOST);
    Question q4 =
        new Question(4, "You have gone up to the bridge. Who are you?", Question.Type.USUAL);
    Question q5 = new Question(5, "You did not attend negotiations. Defeat!", Question.Type.LOST);
    Question q6 = new Question(6, "You have been returned home. Victory!", Question.Type.WON);
    ...
    Answer a4 = new Answer(4, "Refuse to go up the bridge.", q2, q5);
    Answer a5 = new Answer(5, "Tell truth about yourself.", q4, q6);
    Answer a6 = new Answer(6, "Tell lie about yourself.", q4, q7);
  ...
  public Collection<Answer> getAnswers(Integer questionId) {
    return ANSWERS.values().stream()
        .filter(a -> a.getFrom().getId().equals(questionId))
